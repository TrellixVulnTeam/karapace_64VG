...
from karapace.schema_models import SchemaType, SchemaVersion, TypedSchema, ValidatedTypedSchema
...
class KarapaceSchemaRegistry:
    def __init__(self, config: Config) -> None:
        ...
        self.database = SchemaRegistryDictDatabase()
    ...
    async def write_new_schema_local(
        ...
        async with self.schema_lock:
            ...
            if not all_schema_versions:
                ...
                # transitive mode
                schema_versions = sorted(list(live_schema_versions))
    ...
    def get_versions(self, schema_id: int, *, include_deleted: bool = False) -> List[Dict[Subject, ResolvedVersion]]:
        subject_versions = []
        ...
        return cast(List[Dict[Subject, ResolvedVersion]], subject_versions)  # Keep mypy happy
